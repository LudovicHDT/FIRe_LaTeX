...
\usepackage[textheight=678pt,inner=25mm,hmarginratio=2:3,twoside,a4paper]{geometry}
\usepackage{array,tabulary,graphicx}
\usepackage{floatrow}
\usepackage{tikz,minted}
...
\hypersetup{
  ...
  pdfinfo={
    Title={Influence de la morphologie des houppiers sur la transmission de la lumière}
    Author={Ludovic Hondet}
    Keywords={houppier PAR MAR arbre}
  }
}

\titleformat{\chapter}[hang]{\bfseries\LARGE\sffamily}{\thechapter}{0.5em}{}
...
\subsection{Établissement des relations allométriques}\index{relations allométriques}
...
\begin{wrapfigure}{l}{0.45\textwidth}
  \vspace{-20pt}
  \begin{center}
    \includegraphics[width=180pt]{capteur_Morus.png}
  \end{center}
...
\section{Relations allométriques}\index{relations allométriques}
...
\thisfloatsetup{margins=hangleft}
\begin{figure}[!b]
  \centering
  \begin{tiny}
...
necessité un système d'acquisition et de traitement capable de calculer des flux
photoniques dans différentes longueurs d'onde à partir des irradiances
incidentes et transmises. Les résultats de ces 2 expériences ont ensuite été
analysés pour mettre en évidence un lien entre morphologie des houppiers et
transmission de la lumière. L'analyse des résultats a mis en avant un lien entre
la morphologie des houppiers et la transmission de la lumière au sein de chacune
des espèces.\\
...
transmitted irradiances. The results of those 2 experiments were analysed in
